class Cb < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/CrunchyData/homebrew-bridge-unstable/releases/download/v4.0.0-alpha.0/cb-v4.0.0-alpha.0_macos_amd64.zip"
      sha256 "691c83332e91874f0d47bf4f1d16eaf376f2f0e1241c433f9bf20c7f6aa53fa3"
    end
    if Hardware::CPU.arm?
      url "https://github.com/CrunchyData/homebrew-bridge-unstable/releases/download/v4.0.0-alpha.0/cb-v4.0.0-alpha.0_macos_arm64.zip"
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/CrunchyData/homebrew-bridge-unstable/releases/download/v4.0.0-alpha.0/cb-v4.0.0-alpha.0_linux_arm64.zip"
      sha256 "6caefa4acc01f89ff57217079f817eabe8e24cb05a17dcd994fd7fde81b154f9"
    end
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://github.com/CrunchyData/homebrew-bridge-unstable/releases/download/v4.0.0-alpha.0/cb-v4.0.0-alpha.0_linux_amd64.zip"
